...
public class ImportForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnImportFlights.setBackground(new java.awt.Color(255, 217, 142));
        ...
        btnImportLocations.setBackground(new java.awt.Color(255, 217, 142));
        ...
        btnClose.setBackground(new java.awt.Color(255, 217, 142));
        ...
        btnBrowseFlight.setBackground(new java.awt.Color(255, 217, 142));
        ...
        btnBrowseLocation.setBackground(new java.awt.Color(255, 217, 142));
    ...
    private void btnBrowseLocationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBrowseLocationActionPerformed
        ...
        int returnValue = fc.showDialog(this, "Import Locations");   
        if (returnValue == JFileChooser.APPROVE_OPTION){
            File locationsFile = fc.getSelectedFile();
            txtLocations.setText(locationsFile.getAbsolutePath());
        }else{
            JOptionPane.showMessageDialog(this, "No Selected Location File!", "No Selected Location File!", JOptionPane.OK_OPTION);
    ...
    private void btnBrowseFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBrowseFlightActionPerformed
        int returnValue = fc.showDialog(this, "Import Flight");
        
        if (returnValue == JFileChooser.APPROVE_OPTION){
            File flightFile = fc.getSelectedFile();
            txtFlights.setText(flightFile.getAbsolutePath());
        }else{
            JOptionPane.showMessageDialog(this, "No Selected Location File!", "No Selected Location File!", JOptionPane.OK_OPTION);
            System.out.println("No File Chosen");
        }
    ...
    private void btnImportFlightsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportFlightsActionPerformed
        ...
        FlightImporter flightImport = new FlightImporter(txtFlights.getText());
        flightImport.run();
