...
public class BookingForm extends javax.swing.JFrame {
    ...
    public void createCabinClassModel(){
        DefaultComboBoxModel modelClass = new DefaultComboBoxModel();
        for(CabinClass cabinClass: CabinClass.values()){
            modelClass.addElement(cabinClass);
        }
    ...
    public void createToLocationsModel(){
        ...
        for(Location fromLocations: DatabaseOperations.GetAllLocations()){
            
           if (cboFrom.getSelectedItem().toString().equals(fromLocations.toString())){
               //ignores
            
           }else{
               modelTo.addElement(fromLocations);
           }
        }
        cboTo.setModel(modelTo);
    ...
    public void createFromLocationsModel(){
        ...
        for(Location fromLocations: DatabaseOperations.GetAllLocations()){
                modelFrom.addElement(fromLocations);
        }
        cboFrom.setModel(modelFrom);  
    ...
    public void createDatesModel(){
        ...
        String[] from = cboFrom.getSelectedItem().toString().split(" ");
        String departure = from[1];
        String[] to = cboTo.getSelectedItem().toString().split(" ");
        String destination = to[1];

        ArrayList<Flight> flights = DatabaseOperations.GetAllFlightsForLocation(departure, destination);
        
        for(Flight eachFlight: flights){
            dateModel.addElement(eachFlight);
        }
        cboDate.setModel(dateModel);
    }
    ...
    private void initComponents() {
        ...
        btnSearch.setBackground(new java.awt.Color(255, 179, 103));
        ...
        btnBook.setBackground(new java.awt.Color(255, 179, 103));
        ...
        btnClose.setBackground(new java.awt.Color(255, 179, 103));
    ...
    private void btnBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookActionPerformed
        Booking itemBooked = new Booking();
        
        Flight objectToBook = (Flight)cboDate.getSelectedItem();
        itemBooked.setFlightNumber(objectToBook.getFlightNumber());
        itemBooked.setCabinClass(cboClass.getSelectedItem().toString());
        
        if (cboClass.getSelectedItem() == CabinClass.FIRST_CLASS){
            itemBooked.setPrice(objectToBook.getPrice() + (objectToBook.getPrice()*0.30));
            
        }if(cboClass.getSelectedItem() == CabinClass.PRESTIGE_CLASS){
            itemBooked.setPrice(objectToBook.getPrice() + (objectToBook.getPrice()*0.20));
        }else{
            itemBooked.setPrice(objectToBook.getPrice());
        }
        
        //show booking final form
        BookingFinalForm bookingFinalForm = new BookingFinalForm(itemBooked);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        try{
            ...
            JOptionPane.showMessageDialog(this, "Please Select a Date from the Date box");
        }
        if (cboDate.getSelectedItem().getClass() == Flight.class){
